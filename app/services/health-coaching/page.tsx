...
const HealthCoachingPage: React.FC = () => {
  ...
  const focusAreas: FocusArea[] = [
    { label: "Eat Healthier", icon: Apple, color: "text-green-600 bg-green-100" },
    { label: "Physical Exercise", icon: Dumbbell, color: "text-blue-600 bg-blue-100" },
    { label: "Manage Stress", icon: Brain, color: "text-purple-600 bg-purple-100" },
    { label: "Quit Smoking", icon: CheckCircle, color: "text-red-600 bg-red-100" },
    { label: "Control BP", icon: Stethoscope, color: "text-teal-600 bg-teal-100" },
    { label: "Boost Energy", icon: ArrowRight, color: "text-orange-600 bg-orange-100" },
  ];
  ...
  return (
    <main className="font-sans text-slate-700 antialiased bg-white">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative bg-lime-900 overflow-hidden">
        {/* Abstract Background Shapes */}
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-lime-500 blur-3xl opacity-20" />
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-teal-500 blur-3xl opacity-20" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            
            <div className="text-white space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-lime-800 border border-lime-600 text-lime-300 text-sm font-medium">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="text-lime-400">knowing</span> and <span className="text-lime-400">doing</span>.
              </h1>
              
              <p className="text-lg text-lime-100 max-w-xl leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button className="px-8 py-4 bg-lime-500 hover:bg-lime-400 text-lime-950 font-bold rounded-xl transition-all shadow-lg shadow-lime-900/50">
                  Start Your Journey
                </button>
                <div className="flex items-center gap-4 text-sm font-medium text-lime-200 px-4">
                  <div className="flex -space-x-2">
                    {[1,2,3].map(i => (
                      <div key={i} className="w-8 h-8 rounded-full bg-lime-800 border-2 border-lime-900 flex items-center justify-center text-xs">
                        <Users size={12} />
                      </div>
                    ))}
                  </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-lime-800/30 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <img 
                  src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=2070&auto=format&fit=crop" 
                  alt="Health coach talking to client" 
                  className="w-full h-auto object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-lime-900/80 to-transparent flex items-end p-8">
                  <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/20 text-white">
                    ...
                    <p className="text-sm text-lime-100 flex items-center gap-2 mt-1">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-600 mb-12">
            ...
            <span className="font-bold text-lime-700"> Consultant Family Physician</span> with specialized 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Qualified Doctors', 'Registered Nurses', 'Expert Dieticians', 'Exercise Trainers'].map((role, idx) => (
              <div key={idx} className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-center hover:bg-lime-50 hover:border-lime-200 transition-colors">
                <div className="w-2 h-2 rounded-full bg-lime-500 mx-auto mb-3" />
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold tracking-widest text-lime-600 uppercase mb-2">How It Works</h2>
              ...
              <div key={index} className="relative group">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  <div className="flex justify-between items-start mb-4">
                    <span className="text-4xl font-black text-slate-100 group-hover:text-lime-100 transition-colors">
                      {step.number}
                    </span>
                ...
                {/* Arrow connector for desktop (hidden on mobile/last item) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                ...
                <span className="text-lime-600">we have a plan for it.</span>
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {focusAreas.map((area, idx) => (
                  <div key={idx} className="flex items-center gap-3 p-3 rounded-lg border border-slate-100 hover:border-lime-200 transition-colors">
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-slate-900 rounded-[2.5rem] p-10 md:p-16 text-center shadow-2xl overflow-hidden relative">
          
          {/* Decorative background elements */}
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-30">
             <div className="absolute -top-24 -left-24 w-64 h-64 bg-lime-500 rounded-full blur-3xl mix-blend-screen"></div>
             <div className="absolute top-1/2 right-0 w-64 h-64 bg-teal-500 rounded-full blur-3xl mix-blend-screen"></div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <button className="bg-lime-500 text-slate-900 text-lg font-bold py-4 px-12 rounded-full hover:bg-lime-400 transform hover:scale-105 transition duration-300 shadow-[0_0_20px_rgba(132,204,22,0.4)]">
              Get Started
            </button>
